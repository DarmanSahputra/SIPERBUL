...
<div class="w-[330px] h-screen bg-blue-900">
    ...
    <div class="flex flex-col p-2">
        <a href="index.php?page=Dashboard">
            <div class="w-full flex items-center gap-2 p-4 rounded-2xl text-white hover:bg-blue-500 cursor-pointer">
        ...
        <a href="index.php?page=Laporan_Masuk">
            <div class="w-full flex gap-2 p-4 rounded-2xl text-white hover:bg-blue-500 hover:font-semibold cursor-pointer">
                ...
                <span class="text-sm font-semibold">Laporan Masuk</span>
                <span class="ml-auto rounded-full bg-white/15 w-3 h-3 p-3 text-white text-[10px] flex justify-center items-center">1</span>
            </div>
        </a>
        <a href="index.php?page=tindak_lanjut">
            <div class="w-full flex gap-2  p-4 rounded-2xl text-white hover:bg-blue-500 hover:font-semibold cursor-pointer">
                ...
                <span class="text-sm font-semibold">Tindak Lanjutan</span>
            </div>
        </a>
